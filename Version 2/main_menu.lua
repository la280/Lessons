...
if (customName == "") then
    ...
    --------------------------------------------------------------------------------
    --Popup box for when there is insufficient info to edit anything.
    --------------------------------------------------------------------------------

    --local alert = native.showAlert("", "This task has not yet been created.", {"OK"}, onComplete )
...
displayDailyTime = display.newText( dailyEndTime, display.contentWidth/2, 200, "Helvetica", 50 )
...
-----------------------------------------------------------------------------------------
-- Time function that calculates how much work you have to do per day
-----------------------------------------------------------------------------------------   
...
-----------------------------------------------------------------------------------------
-- Function that displays the workload
-----------------------------------------------------------------------------------------   
...
-----------------------------------------------------------------------------------------   
        ...
        if  ( (dailyWorkLoad > 0) and (dailyWorkLoad < 0.9) ) then
            ...
            -- Create one day countdown function (6 seconds for default)
            local function checkTime( event )

               -- Display text showing the countdown to the dailyEndTime
               displayDailyTime.text = dailyEndTime - ( now - startTime )

               if ( now > startTime + dailyEndTime ) then
                  -- Change the text to notify when the timer is done
                   displayDailyTime.text = ( "Time's up" )
               end
            end
...
-----------------------------------------------------------------------------------------   
        ...
        -- If the workload is between 0.9 and 1.9    
        elseif ( (dailyWorkLoad > 0.9) and (dailyWorkLoad < 1.9) ) then
